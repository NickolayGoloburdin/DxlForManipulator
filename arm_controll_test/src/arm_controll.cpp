...
// void messageJointscmd(const sensor_msgs::JointState::ConstPtr& toggle_msg, boost::numeric::ublas::Manipulator* manip
// )  //controll position
//     {
...
int main(int argc, char** argv) {
  ...
  Manipulator* manip = new Delta;

  sensor_msgs::JointState joints_msg;
  sensor_msgs::JointState temp_load;
  // ros::Subscriber jointcmd = nh.subscribe<sensor_msgs::JointState> ("cmd_joints",10, boost::bind(messageJointscmd,
  // _1, manip)); ros::Subscriber torque_motor = nh.subscribe<std_msgs::Bool> ("disable_torque",10,
